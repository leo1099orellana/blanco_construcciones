...
export default function WhatsAppFab() {
  return (
    <a
      ...
      aria-label="WhatsApp"
      className="fixed bottom-6 right-6 z-50 w-[60px] h-[60px] rounded-full bg-wa grid place-items-center
        shadow-[0_10px_26px_rgba(37,211,102,.45)] animate-bounce hover:scale-110 transition-transform duration-200"
